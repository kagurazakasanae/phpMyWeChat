...
class UploadMsgImgRequest extends \ProtobufMessage
{
    ...
    public function reset()
    {
        ...
        $this->values[self::NETTYPE] = self::$fields[self::NETTYPE]['default'];
        $this->values[self::PHOTOFROM] = self::$fields[self::PHOTOFROM]['default'];
        $this->values[self::UICREATETIME] = self::$fields[self::UICREATETIME]['default'];
        ...
        $this->values[self::REQTIME] = self::$fields[self::REQTIME]['default'];
        $this->values[self::MD5] = null;
        $this->values[self::CRC32] = null;
        $this->values[self::MSGFORWARDTYPE] = self::$fields[self::MSGFORWARDTYPE]['default'];
